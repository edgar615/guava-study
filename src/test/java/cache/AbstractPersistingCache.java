...
//                            notification.getKey(), notification.getValue()), e);
                    System.err.println(String.format("Could not persist value %s to key %s",
                                                      notification.getKey(), notification
                                                              .getValue()));
                }
...
//                LOGGER.warn(String.format("Could not load persisted value to key %s", key), e);
                System.err.println(String.format("Could not load persisted value to key %s", key)    );
            }
            if (value != null) {
                return value;
            } else {
    ...
    public V getIfPresent(Object key) {
        try {
          ...
          System.out.println(String.format("Could not cast key %s to desired type", key));
...
//            LOGGER.warn(String.format("Persisted value to key %s could not be retrieved", key), e);
          System.out.println(String.format("Persisted value to key %s could not be retrieved", key));
...
//            LOGGER.info(String.format("Could not cast key %s to desired type", key), e);
          System.err.println(String.format("Could not cast key %s to desired type", key));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
